# Network Interoperability Graph — Feedback
...
Use one of the GitHub Issue Forms provided by this repository:

- **Missing combination / new evidence** — report a device + cable/optic relationship that is missing, or provide new direct evidence for an existing relationship.
- **Correction / conflicting evidence** — report a result that appears wrong or provide evidence that contradicts what is currently shown.

Please provide exact model/SKU information wherever possible, including the device, port, cable/optic component, operating speed, and material firmware/driver/OS/configuration context. Include a direct evidence/source URL.
